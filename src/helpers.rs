...
impl<const L: Fraction, const R: Fraction> Helpers<L, R> {
    ...
    pub const DIVISOR: u64 = gcd::binary_u64(L.1 as u64 * R.0 as u64, R.1 as u64 * L.0 as u64);

    /// Helper constants generated at compile time
    pub const DIVISOR_2: u64 = gcd::binary_u64(L.0 as u64 * R.0 as u64, R.1 as u64 * L.1 as u64);

    /// Helper constants generated at compile time for Durations
    pub const RD_TIMES_LN: u64 = (R.1 as u64 * L.0 as u64) / Self::DIVISOR;

    /// Helper constants generated at compile time
    pub const LD_TIMES_RN: u64 = (L.1 as u64 * R.0 as u64) / Self::DIVISOR;

    /// Helper constants generated at compile time for Rates
    pub const LN_TIMES_RN: u64 = (L.0 as u64 * R.0 as u64) / Self::DIVISOR_2;

    /// Helper constants generated at compile time for Rates
    pub const RD_TIMES_LD: u64 = (R.1 as u64 * L.1 as u64) / Self::DIVISOR_2;
