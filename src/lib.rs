...
mod fraction {
    ...
    pub type Fraction = (u32, u32);

    pub const NANO: Fraction = (1, 1_000_000_000);
    pub const MICRO: Fraction = (1, 1_000_000);
    pub const MILLI: Fraction = (1, 1_000);
    pub const ONE: Fraction = (1, 1);
    pub const KILO: Fraction = (1_000, 1);
    pub const MEGA: Fraction = (1_000_000, 1);

    pub const fn const_eq(left: Fraction, other: Fraction) -> bool {
        left.0 == other.0 && left.1 == other.1
    }
}
...
mod test {
    ...
    fn duration_compare_u32() {
        // Same fraction
        assert!(
            Duration::<u32, { (1, 1_000) }>::from_ticks(2)
        ...
        // Different fraction
        assert!(
            Duration::<u32, { (1, 10_000) }>::from_ticks(11)
                > Duration::<u32, { (1, 1_000) }>::from_ticks(1)
        );
        assert!(
            Duration::<u32, { (1, 10_000) }>::from_ticks(11)
        ...
        assert!(
            Duration::<u32, { (1, 10_000) }>::from_ticks(10)
                >= Duration::<u32, { (1, 1_000) }>::from_ticks(1)
        );
        assert!(
            Duration::<u32, { (1, 10_000) }>::from_ticks(11)
        ...
        assert!(
            Duration::<u32, { (1, 10_000) }>::from_ticks(1)
                <= Duration::<u32, { (1, 1_000) }>::from_ticks(1)
        );
        assert!(
            Duration::<u32, { (1, 10_000) }>::from_ticks(10)
        ...
        assert!(
            Duration::<u32, { (1, 10_000) }>::from_ticks(9)
                != Duration::<u32, { (1, 1_000) }>::from_ticks(2)
        );

        // From instants
        assert!(
            Instant::<u32, { (1, 1_000) }>::from_ticks(10)
                - Instant::<u32, { (1, 1_000) }>::from_ticks(5)
    ...
    fn duration_compare_u64() {
        // Same fraction
        assert!(
            Duration::<u64, { (1, 1_000) }>::from_ticks(2)
        ...
        // Different fraction
        assert!(
            Duration::<u64, { (1, 10_000) }>::from_ticks(11)
                > Duration::<u64, { (1, 1_000) }>::from_ticks(1)
        );
        assert!(
            Duration::<u64, { (1, 10_000) }>::from_ticks(11)
        ...
        assert!(
            Duration::<u64, { (1, 10_000) }>::from_ticks(10)
                >= Duration::<u64, { (1, 1_000) }>::from_ticks(1)
        );
        assert!(
            Duration::<u64, { (1, 10_000) }>::from_ticks(11)
        ...
        assert!(
            Duration::<u64, { (1, 10_000) }>::from_ticks(1)
                <= Duration::<u64, { (1, 1_000) }>::from_ticks(1)
        );
        assert!(
            Duration::<u64, { (1, 10_000) }>::from_ticks(10)
        ...
        assert!(
            Duration::<u64, { (1, 10_000) }>::from_ticks(9)
                != Duration::<u64, { (1, 1_000) }>::from_ticks(2)
        );

        // From instants
        assert!(
            Instant::<u64, { (1, 1_000) }>::from_ticks(10)
                - Instant::<u64, { (1, 1_000) }>::from_ticks(5)
    ...
    fn duration_duration_math_u32() {
        ...
        // Same base
        let sum: Duration<u32, { (1, 1_000) }> = Duration::<u32, { (1, 1_000) }>::from_ticks(10)
            + Duration::<u32, { (1, 1_000) }>::from_ticks(1);
        ...
        let diff: Duration<u32, { (1, 1_000) }> = Duration::<u32, { (1, 1_000) }>::from_ticks(10)
            - Duration::<u32, { (1, 1_000) }>::from_ticks(1);
        ...
        // Fixed in v0.3.2
        let d: Duration<u32, { (1, 1_000) }> =
            Duration::<u32, { (1, 32_768) }>::from_ticks(42949672).convert();
        assert_eq!(d.ticks(), 1_310_719);

        // Division and multiplication by integers
        let mul: Duration<u32, { (1, 1_000) }> =
            Duration::<u32, { (1, 1_000) }>::from_ticks(10) * 2;
        ...
        assert_eq!(
            Duration::<u32, { (1, 100) }>::from_ticks(5)
                / Duration::<u32, { (1, 1_000) }>::from_ticks(2),
            25
        );
        ...
        assert_eq!(
            Duration::<u32, { (1, 1_000) }>::from_ticks(500)
                / Duration::<u32, { (1, 100) }>::from_ticks(5),
            10
        );
    }
    ...
    fn duration_duration_math_u64() {
        ...
        // Same base
        let sum: Duration<u64, { (1, 1_000) }> = Duration::<u64, { (1, 1_000) }>::from_ticks(10)
            + Duration::<u64, { (1, 1_000) }>::from_ticks(1);
        ...
        let diff: Duration<u64, { (1, 1_000) }> = Duration::<u64, { (1, 1_000) }>::from_ticks(10)
            - Duration::<u64, { (1, 1_000) }>::from_ticks(1);
        ...
        // Division and multiplication by integers
        let mul: Duration<u64, { (1, 1_000) }> =
            Duration::<u64, { (1, 1_000) }>::from_ticks(10) * 2;
        ...
        assert_eq!(
            Duration::<u64, { (1, 1_00) }>::from_ticks(5)
                / Duration::<u64, { (1, 1_000) }>::from_ticks(2),
            25
        );
        ...
        assert_eq!(
            Duration::<u64, { (1, 1_000) }>::from_ticks(500)
                / Duration::<u64, { (1, 1_00) }>::from_ticks(5),
            10
        );
    }
    ...
    fn instant_compare_u32() {
        ...
        assert_eq!(
            Instant::<u32, { (1, 1_000) }>::from_ticks(1).checked_duration_since(Instant::<
                u32,
                { (1, 1_000) },
            >::from_ticks(
                1
        ...
        assert_eq!(
            Instant::<u32, { (1, 1_000) }>::from_ticks(2).checked_duration_since(Instant::<
                u32,
                { (1, 1_000) },
            >::from_ticks(
                1
    ...
    fn instant_compare_u64() {
        ...
        // Checked duration since non-wrapping
        assert_eq!(
            Instant::<u64, { (1, 1_000) }>::from_ticks(1).checked_duration_since(Instant::<
                u64,
                { (1, 1_000) },
            >::from_ticks(
                1
        ...
        assert_eq!(
            Instant::<u64, { (1, 1_000) }>::from_ticks(2).checked_duration_since(Instant::<
                u64,
                { (1, 1_000) },
            >::from_ticks(
                1
    ...
    fn instant_duration_math_u32() {
        ...
        let diff: Duration<u32, { (1, 1_000) }> = Instant::<u32, { (1, 1_000) }>::from_ticks(10)
            - Instant::<u32, { (1, 1_000) }>::from_ticks(1);
        assert_eq!(diff, Duration::<u32, { (1, 1_000) }>::from_ticks(9));

        // Instant +- Duration, Same base
        let sum: Instant<u32, { (1, 1_000) }> = Instant::<u32, { (1, 1_000) }>::from_ticks(10)
            + Duration::<u32, { (1, 1_000) }>::from_ticks(1);
        ...
        let diff: Instant<u32, { (1, 1_000) }> = Instant::<u32, { (1, 1_000) }>::from_ticks(10)
            - Duration::<u32, { (1, 1_000) }>::from_ticks(1);
        ...
        let sum: Instant<u32, { (1, 10_000) }> =
            Instant::<u32, { (1, 10_000) }>::from_ticks(10) + 1.millis();
        assert_eq!(sum, Instant::<u32, { (1, 10_000) }>::from_ticks(20));
    ...
    fn instant_duration_math_u64() {
        ...
        // Instant - Instant, Same base
        let diff: Duration<u64, { (1, 1_000) }> = Instant::<u64, { (1, 1_000) }>::from_ticks(10)
            - Instant::<u64, { (1, 1_000) }>::from_ticks(1);
        assert_eq!(diff, Duration::<u64, { (1, 1_000) }>::from_ticks(9));

        // Instant +- Duration, Same base
        let sum: Instant<u64, { (1, 1_000) }> = Instant::<u64, { (1, 1_000) }>::from_ticks(10)
            + Duration::<u64, { (1, 1_000) }>::from_ticks(1);
        ...
        let diff: Instant<u64, { (1, 1_000) }> = Instant::<u64, { (1, 1_000) }>::from_ticks(10)
            - Duration::<u64, { (1, 1_000) }>::from_ticks(1);
        ...
        let sum: Instant<u64, { (1, 10_000) }> =
            Instant::<u64, { (1, 10_000) }>::from_ticks(10) + 1.millis();
        assert_eq!(sum, Instant::<u64, { (1, 10_000) }>::from_ticks(20));
    ...
    fn rate_compare_u32() {
        // Same fraction
        assert!(
            Rate::<u32, { (1_000, 1) }>::from_raw(2) > Rate::<u32, { (1_000, 1) }>::from_raw(1)
        );
        assert!(
            Rate::<u32, { (1_000, 1) }>::from_raw(2) >= Rate::<u32, { (1_000, 1) }>::from_raw(1)
        );
        assert!(
            Rate::<u32, { (1_000, 1) }>::from_raw(1) >= Rate::<u32, { (1_000, 1) }>::from_raw(1)
        );
        assert!(
            Rate::<u32, { (1_000, 1) }>::from_raw(1) < Rate::<u32, { (1_000, 1) }>::from_raw(2)
        );
        assert!(
            Rate::<u32, { (1_000, 1) }>::from_raw(1) <= Rate::<u32, { (1_000, 1) }>::from_raw(1)
        );
        ...
        // Different fraction
        assert!(
            Rate::<u32, { (1_000, 1) }>::from_raw(11) > Rate::<u32, { (10_000, 1) }>::from_raw(1)
        );
        assert!(
            Rate::<u32, { (1_000, 1) }>::from_raw(11) >= Rate::<u32, { (10_000, 1) }>::from_raw(1)
        );
        assert!(
            Rate::<u32, { (1_000, 1) }>::from_raw(10) >= Rate::<u32, { (10_000, 1) }>::from_raw(1)
        );
        assert!(
            Rate::<u32, { (1_000, 1) }>::from_raw(11) < Rate::<u32, { (10_000, 1) }>::from_raw(2)
        );
        assert!(
            Rate::<u32, { (1_000, 1) }>::from_raw(1) <= Rate::<u32, { (10_000, 1) }>::from_raw(1)
        );
        assert!(
            Rate::<u32, { (1_000, 1) }>::from_raw(10) <= Rate::<u32, { (10_000, 1) }>::from_raw(1)
        );
        ...
        assert!(
            Rate::<u32, { (1_000, 1) }>::from_raw(9) != Rate::<u32, { (10_000, 1) }>::from_raw(2)
        );
    }
    ...
    fn rate_compare_u64() {
        // Same fraction
        assert!(
            Rate::<u64, { (1_000, 1) }>::from_raw(2) > Rate::<u64, { (1_000, 1) }>::from_raw(1)
        );
        assert!(
            Rate::<u64, { (1_000, 1) }>::from_raw(2) >= Rate::<u64, { (1_000, 1) }>::from_raw(1)
        );
        assert!(
            Rate::<u64, { (1_000, 1) }>::from_raw(1) >= Rate::<u64, { (1_000, 1) }>::from_raw(1)
        );
        assert!(
            Rate::<u64, { (1_000, 1) }>::from_raw(1) < Rate::<u64, { (1_000, 1) }>::from_raw(2)
        );
        assert!(
            Rate::<u64, { (1_000, 1) }>::from_raw(1) <= Rate::<u64, { (1_000, 1) }>::from_raw(1)
        );
        ...
        // Different fraction
        assert!(
            Rate::<u64, { (1_000, 1) }>::from_raw(11) > Rate::<u64, { (10_000, 1) }>::from_raw(1)
        );
        assert!(
            Rate::<u64, { (1_000, 1) }>::from_raw(11) >= Rate::<u64, { (10_000, 1) }>::from_raw(1)
        );
        assert!(
            Rate::<u64, { (1_000, 1) }>::from_raw(10) >= Rate::<u64, { (10_000, 1) }>::from_raw(1)
        );
        assert!(
            Rate::<u64, { (1_000, 1) }>::from_raw(11) < Rate::<u64, { (10_000, 1) }>::from_raw(2)
        );
        assert!(
            Rate::<u64, { (1_000, 1) }>::from_raw(1) <= Rate::<u64, { (10_000, 1) }>::from_raw(1)
        );
        assert!(
            Rate::<u64, { (1_000, 1) }>::from_raw(10) <= Rate::<u64, { (10_000, 1) }>::from_raw(1)
        );
        ...
        assert!(
            Rate::<u64, { (1_000, 1) }>::from_raw(9) != Rate::<u64, { (10_000, 1) }>::from_raw(2)
        );
    }
    ...
    fn rate_compare_u64_u32() {
        // Same fraction
        assert!(
            Rate::<u64, { (1_000, 1) }>::from_raw(2) > Rate::<u32, { (1_000, 1) }>::from_raw(1)
        );
        assert!(
            Rate::<u64, { (1_000, 1) }>::from_raw(2) >= Rate::<u32, { (1_000, 1) }>::from_raw(1)
        );
        assert!(
            Rate::<u64, { (1_000, 1) }>::from_raw(1) >= Rate::<u32, { (1_000, 1) }>::from_raw(1)
        );
        assert!(
            Rate::<u64, { (1_000, 1) }>::from_raw(1) < Rate::<u32, { (1_000, 1) }>::from_raw(2)
        );
        assert!(
            Rate::<u64, { (1_000, 1) }>::from_raw(1) <= Rate::<u32, { (1_000, 1) }>::from_raw(1)
        );
        ...
        // Different fraction
        assert!(
            Rate::<u64, { (1_000, 1) }>::from_raw(11) > Rate::<u32, { (10_000, 1) }>::from_raw(1)
        );
        assert!(
            Rate::<u64, { (1_000, 1) }>::from_raw(11) >= Rate::<u32, { (10_000, 1) }>::from_raw(1)
        );
        assert!(
            Rate::<u64, { (1_000, 1) }>::from_raw(10) >= Rate::<u32, { (10_000, 1) }>::from_raw(1)
        );
        assert!(
            Rate::<u64, { (1_000, 1) }>::from_raw(11) < Rate::<u32, { (10_000, 1) }>::from_raw(2)
        );
        assert!(
            Rate::<u64, { (1_000, 1) }>::from_raw(1) <= Rate::<u32, { (10_000, 1) }>::from_raw(1)
        );
        assert!(
            Rate::<u64, { (1_000, 1) }>::from_raw(10) <= Rate::<u32, { (10_000, 1) }>::from_raw(1)
        );
        ...
        assert!(
            Rate::<u64, { (1_000, 1) }>::from_raw(9) != Rate::<u32, { (10_000, 1) }>::from_raw(2)
        );
    }
    ...
    fn rate_compare_u32_u64() {
        // Same fraction
        assert!(
            Rate::<u32, { (1_000, 1) }>::from_raw(2) > Rate::<u64, { (1_000, 1) }>::from_raw(1)
        );
        assert!(
            Rate::<u32, { (1_000, 1) }>::from_raw(2) >= Rate::<u64, { (1_000, 1) }>::from_raw(1)
        );
        assert!(
            Rate::<u32, { (1_000, 1) }>::from_raw(1) >= Rate::<u64, { (1_000, 1) }>::from_raw(1)
        );
        assert!(
            Rate::<u32, { (1_000, 1) }>::from_raw(1) < Rate::<u64, { (1_000, 1) }>::from_raw(2)
        );
        assert!(
            Rate::<u32, { (1_000, 1) }>::from_raw(1) <= Rate::<u64, { (1_000, 1) }>::from_raw(1)
        );
        ...
        // Different fraction
        assert!(
            Rate::<u32, { (1_000, 1) }>::from_raw(11) > Rate::<u64, { (10_000, 1) }>::from_raw(1)
        );
        assert!(
            Rate::<u32, { (1_000, 1) }>::from_raw(11) >= Rate::<u64, { (10_000, 1) }>::from_raw(1)
        );
        assert!(
            Rate::<u32, { (1_000, 1) }>::from_raw(10) >= Rate::<u64, { (10_000, 1) }>::from_raw(1)
        );
        assert!(
            Rate::<u32, { (1_000, 1) }>::from_raw(11) < Rate::<u64, { (10_000, 1) }>::from_raw(2)
        );
        assert!(
            Rate::<u32, { (1_000, 1) }>::from_raw(1) <= Rate::<u64, { (10_000, 1) }>::from_raw(1)
        );
        assert!(
            Rate::<u32, { (1_000, 1) }>::from_raw(10) <= Rate::<u64, { (10_000, 1) }>::from_raw(1)
        );
        ...
        assert!(
            Rate::<u32, { (1_000, 1) }>::from_raw(9) != Rate::<u64, { (10_000, 1) }>::from_raw(2)
        );
    }
    ...
    fn rate_rate_math_u32() {
        ...
        // Different base
        let sum: Rate<u32, { (10_000, 1) }> = Rate::<u32, { (10_000, 1) }>::from_raw(10)
            + Rate::<u32, { (1_000, 1) }>::from_raw(10).convert();
        assert_eq!(sum, Rate::<u32, { (10_000, 1) }>::from_raw(11));

        let diff: Rate<u32, { (10_000, 1) }> = Rate::<u32, { (10_000, 1) }>::from_raw(10)
            - Rate::<u32, { (1_000, 1) }>::from_raw(10).convert();
    ...
    fn rate_rate_math_u64() {
        ...
        // Different base
        let sum: Rate<u64, { (10_000, 1) }> = Rate::<u64, { (10_000, 1) }>::from_raw(10)
            + Rate::<u64, { (1_000, 1) }>::from_raw(10).convert();
        assert_eq!(sum, Rate::<u64, { (10_000, 1) }>::from_raw(11));

        let diff: Rate<u64, { (10_000, 1) }> = Rate::<u64, { (10_000, 1) }>::from_raw(10)
            - Rate::<u64, { (1_000, 1) }>::from_raw(10).convert();
